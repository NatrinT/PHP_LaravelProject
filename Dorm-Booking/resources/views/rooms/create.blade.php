            ...
            <form action="/room/" method="post" enctype="multipart/form-data" class="ship-form">
                ...
                <div class="ship-row">
                    ...
                    <div class="ship-field">
                        <input type="text" name="room_no" value="{{ old('room_no') }}" placeholder="Room Number" required
                            minlength="3">
                ...
                <div class="ship-row">
                    ...
                    <div class="ship-field ship-grid-2">
                        <div>
                            <input type="number" name="floor" value="{{ old('floor') }}" placeholder="Floor"
                                min="1" required>
                    ...
                    <div class="ship-field">
                        <div class="ship-select-wrap">
                            <select name="status" required>
                                ...
                                <option value="OCCUPIED" {{ old('status') == 'OCCUPIED' ? 'selected' : '' }}>มีผู้เช่า
                                </option>
                ...
                <div class="ship-row">
                    ...
                    <div class="ship-field">
                        <input type="number" name="monthly_rent" value="{{ old('monthly_rent') }}"
                            placeholder="Monthly rent min 500 baht" min="500" required>
                ...
                <div class="ship-row">
                    ...
                    <div class="ship-field">
                        ...
                        <select name="branch" required>
                            <option value="SRINAKARIN" {{ old('branch') == 'SRINAKARIN' ? 'selected' : '' }}>SRINAKARIN</option>
                            <option value="RAMA9" {{ old('branch') == 'RAMA9' ? 'selected' : '' }}>RAMA9</option>
                            <option value="ASOKE" {{ old('branch') == 'ASOKE' ? 'selected' : '' }}>ASOKE</option>
                            <option value="ROMKLAO" {{ old('branch') == 'ROMKLAO' ? 'selected' : '' }}>ROMKLAO</option>
                        </select>
